...
<template>
    <Head title="Login Admin Kehadiran" />

    <div class="flex min-h-screen items-center justify-center bg-gray-100">
        <Card class="w-full max-w-sm">
            <CardHeader class="space-y-1">
                <CardTitle class="text-2xl">Akses Admin Kehadiran</CardTitle>
                <CardDescription>
                    Masukkan kredensial Admin Kehadiran untuk memulai sesi.
                </CardDescription>
            </CardHeader>
            <CardContent>
                <div
                ...
                <form @submit.prevent="onSubmit" class="flex flex-col gap-6">
                    ...
                    >
                        <FormItem>
                            <FormLabel>Username Admin Kehadiran</FormLabel>
                            <FormControl>
                                <Input
                                    type="text"
