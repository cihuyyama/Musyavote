...
const props = defineProps({
    ...
    formatInfo: {
        type: String,
        default:
            'Pastikan file Excel memiliki header kolom: nama, asal_pimpinan, jenis_kelamin (L/P). Status otomatis "Aktif".',
    },
});
            ...
            <form @submit.prevent="submit" class="space-y-4">
                ...
                <Alert class="border-blue-200 bg-blue-50">
                    ...
                    <AlertDescription class="text-sm text-blue-800">
                        <strong>Format yang benar:</strong> File Excel dengan 3
                        kolom: nama, asal_pimpinan, jenis_kelamin
                    </AlertDescription>
                </Alert>
