  ...
  <div>
    ...
    <div class="flex flex-col space-y-4 py-4">
      ...
      <div class="flex items-center">
        <Input class="max-w-sm" placeholder="Pencarian nama..."
        ...
        <DropdownMenu>
          <DropdownMenuTrigger as-child>
            <Button variant="outline" class="flex items-center gap-2">
              ...
              <Badge v-if="pleno1Filter" variant="secondary" class="ml-1">
                {{ pleno1Filter === 'hadir' ? 'Hadir' : 'Tidak Hadir' }}
              </Badge>
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger as-child>
            <Button variant="outline" class="flex items-center gap-2">
              Pleno 2
              <ChevronDownIcon class="h-4 w-4" />
              <Badge v-if="pleno2Filter" variant="secondary" class="ml-1">
                {{ pleno2Filter === 'hadir' ? 'Hadir' : 'Tidak Hadir' }}
              </Badge>
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger as-child>
            <Button variant="outline" class="flex items-center gap-2">
              Pleno 3
              <ChevronDownIcon class="h-4 w-4" />
              <Badge v-if="pleno3Filter" variant="secondary" class="ml-1">
                {{ pleno3Filter === 'hadir' ? 'Hadir' : 'Tidak Hadir' }}
              </Badge>
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger as-child>
            <Button variant="outline" class="flex items-center gap-2">
              Pleno 4
              <ChevronDownIcon class="h-4 w-4" />
              <Badge v-if="pleno4Filter" variant="secondary" class="ml-1">
                {{ pleno4Filter === 'hadir' ? 'Hadir' : 'Tidak Hadir' }}
              </Badge>
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent>
